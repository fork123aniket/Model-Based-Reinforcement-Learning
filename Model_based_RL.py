...
H, learning_rate, gamma, decay_rate = 8, 1e-2, 0.99, 0.99
resume, model_bs, real_bs, D, mH = False, 3, 3, 4, 256
    ...
    while episode_number <= 5000:
        ...
        if done:
            ...
            if switch_point + batch_size == episode_number:
                ...
                if not drawFromModel:
                    print('World Perf: Episode %.0f, Reward %.1f, action: %.0f, mean reward %.1f.' % (
                        real_episodes, reward_sum/real_bs, action, running_reward/real_bs))
                    Avg_reward.append(running_reward / real_bs)
                    Epochs.append(real_episodes)
